...
var GridVisualization = function(width, height, gridWidth, gridHeight, context, interactionHandler) {
        ...
        this.drawLayer = function(portrayalLayer) {
                ...
                for (var i in portrayalLayer) {
                        ...
                        if (p.Shape == "rect")
                                ...
                                this.drawCircle(p.x, p.y, p.r, p.Color, p.stroke_color, p.Filled, p.text, p.text_color, p.font);
        ...
        */
        this.drawCircle = function(x, y, radius, colors, stroke_color, fill, text, text_color, font) {
